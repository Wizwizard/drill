...
var SqlHighlightRules = function() {
    ...
    var keywords = (
        ...
        "show|describe|use|" +
        //picasso add
        "all|exists|full|in|is|partition|to|unique|unknown"
    );
    ...
    var builtinFunctions = (
        ...
        "coalesce|nullif|" +
        //picasso add
        "timezone_hour|timezone_minute|convert|row_number|substring"
    );

    //Drill-specific
    var dataTypes = (
        "BIGINT|BINARY|BOOLEAN|CHAR|CHARACTER|DATE|DEC|DECIMAL|DOUBLE|FIXED16CHAR|FIXEDBINARY|FLOAT|INT|" +
        "INTEGER|INTERVAL|INTERVALDAY|INTERVALYEAR|NUMERIC|NULL|SMALLINT|TINYINT|TIME|TIMESTAMP|VARBINARY|" +
        "VAR16CHAR|VARCHAR");
